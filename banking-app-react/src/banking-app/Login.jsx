...
function Login(){
     ...
     const handleLogin = async (e) =>{
      //prevent to place the parameters in the url
       ...
       const requestResult = await axios.post(`${baseUrl}/${emailLogin}/${passwordLogin}`);
      ...
      //verify if the returned value is different than null
       if(!requestResult.data){
        ...
        navigate("/dashboard", {state:{user, jwt, emailLogin, passwordLogin}});
       }
     }
    ...
    return(
      ...
      <div className="nav-container">
       ...
       <div className="login-form-container container bg-light">
        <h2 className="text-center mb-5 login-form-title">
            Log in
          </h2>
        ...
        <form className="login-form" onSubmit={(e) => handleLogin(e)}>
          ...
          <div class="mb-3 login-password-container">
            ...
            <span class="show-password-icon " onClick={()=> setShowPassword(!showPassword)} >{showPassword ? <EyeOff /> : <Eye />}</span>
            <input
